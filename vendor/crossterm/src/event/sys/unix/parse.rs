...
fn parse_cb(cb: u8) -> io::Result<(MouseEventKind, KeyModifiers)> {
    ...
    let kind = match (button_number, dragging) {
        ...
        (8, false) => MouseEventKind::Down(MouseButton::Back),
        (9, false) => MouseEventKind::Down(MouseButton::Forward),
...
mod tests {
    ...
    fn test_parse_csi_sgr_mouse() {
        ...
        assert_eq!(
            ...
            Some(InternalEvent::Event(Event::Mouse(MouseEvent {
                kind: MouseEventKind::Down(MouseButton::Back),
                column: 19,
                row: 9,
                modifiers: KeyModifiers::empty(),
            })))
        ...
        assert_eq!(
            ...
            Some(InternalEvent::Event(Event::Mouse(MouseEvent {
                kind: MouseEventKind::Down(MouseButton::Forward),
                column: 19,
                row: 9,
                modifiers: KeyModifiers::empty(),
            })))
        ...
        assert_eq!(
            parse_csi_sgr_mouse(b"\x1B[<128;20;10m").unwrap(),
            Some(InternalEvent::Event(Event::Mouse(MouseEvent {
                kind: MouseEventKind::Up(MouseButton::Back),
                column: 19,
                row: 9,
                modifiers: KeyModifiers::empty(),
            })))
